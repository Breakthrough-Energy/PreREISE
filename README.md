...
## Main Features
**PreREISE** is dedicated to the building of demand, hydro, solar and wind profiles.
Note that profiles are publicly available for the Breakthrough Energy Sciences (BES)
...
A detailed presentation of the data source and algorithms used to generate profiles can
...
adjacent to your clone of **PreREISE** as the installation of packages depends on
...
## Installation
Modules located in the **PowerSimData** package are imported. In particular, profiles
generation relies heavily on `Grid` objects. Follow the instructions in the README of
the [PowerSimData] package to install our software ecosystem.
