...
RAP grid is located and the U and V components of the wind speed at 80-m
above ground is retrieved. This operation is repeated for each 1-hour
data point. Note that that there are some missing data.
"""
