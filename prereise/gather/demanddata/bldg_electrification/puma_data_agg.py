...
def aggregate_puma_df(puma_fuel_2010, tract_puma_mapping):
    ...
    for col in sum_columns:
        ...
        puma_df.loc[grouped_tracts.groups.keys(), col] = grouped_tracts[col_to_sum].sum()
    ...
    puma_df["frac_sh_res_solar"] = puma_fuel_2010["hh_solar"] / puma_fuel_2010["hh_total"]
    puma_df["frac_sh_res_elec"] = puma_fuel_2010["hh_elec"] / puma_fuel_2010["hh_total"]
    puma_df["frac_sh_res_other"] = puma_fuel_2010["hh_other"] / puma_fuel_2010["hh_total"]
