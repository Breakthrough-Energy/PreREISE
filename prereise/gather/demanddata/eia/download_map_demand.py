...
def get_BA_demand(ba_code_list, start_date, end_date, api_key):
    """ Downloads the demand between the start and end dates for a list of BAs
        :param dataframe ba_code_list List of balancing authorities to download from eia
        :param datetime start_date beginning bound for the demand dataframe
        :param datetime end_date end bound for the demand dataframe
    """
