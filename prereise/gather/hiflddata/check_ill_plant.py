...
if __name__ == "__main__":
    ...
    csv_writer1.writerow(['plant_id','bus_id', 'distance','plant_Pmax','bus_capacity','true_load'])
    with open("output/check_plant/plant_bus_distance_capacity.csv", "w", newline="") as plant_bus:
        csv_writer = csv.writer(plant_bus)
        csv_writer.writerow(['plant_id','bus_id', 'distance','plant_Pmax','bus_capacity','true_load'])
