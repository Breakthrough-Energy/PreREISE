...
def Neighbors(sub_by_coord_dict, sub_name_dict, raw_lines):
    ...
    for i in range(len(data['features'])):
        ...
        lines.append([line_id, line_type, sub_by_coord_dict.get(sub1)[0], sub_by_coord_dict.get(sub1)[1],
                      sub_by_coord_dict.get(sub2)[0], sub_by_coord_dict.get(sub2)[1], dist])
