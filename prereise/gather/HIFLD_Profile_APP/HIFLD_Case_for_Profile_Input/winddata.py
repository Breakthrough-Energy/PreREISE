...
from prereise.gather.winddata.rap import helpers, impute, rap

print("wind data population")
electricity_grid = Grid("Texas")

wind_farm = electricity_grid.plant.groupby("type").get_group("wind")
wind_farm_data, wind_farm_data_missing = rap.retrieve_data(
    wind_farm, start_date="2021-01-01", end_date="2021-03-31"
)
