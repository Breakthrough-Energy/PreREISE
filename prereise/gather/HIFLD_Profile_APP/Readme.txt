Data Download would cost over 8 hours. If don’t want to wait. The downloaded data is already in target folder. If just want to test, please start at Step3.
...
Run command "python demand_divide.py". The output will be in folder 
